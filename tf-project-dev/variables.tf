...
variable "sa_dbt" {
  description = "Google Cloud Platform SA for dbt"
  type        = string
}

variable "cs_pbk_dbt" {
  description = "Google Cloud Scheduler for dbt transformation"
  type        = string
}
...
variable "gcs_pbk_dbt_bucket_name" {
  description = "Google Cloud Storage Bucket for dbt"
  type        = string
}

variable "bq_pbk_dbt_dataset" {
  description = "Google Cloud BigQuery Dataset"
  type        = string
}

variable "bq_pbk_dbt_table" {
  description = "Google Cloud BigQuery Table for capacity over time"
  type        = string
}